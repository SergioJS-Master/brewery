...
import { faCircleCheck, faMobileScreen, faTruck } from '@fortawesome/free-solid-svg-icons'
      ...
      <div className={styles.checkout}>
        <div className={styles.checkoutLeft}>
          <div className={styles.headerCheckoutLeft}>
            <div className={styles.btnCheckoutLeft}>SHIPPING</div>
            <div className={styles.btnCheckoutLeft}>REVIEW & PAYMENTS</div>
          </div>
          <p className={styles.textA}>SHIPPING ADDRESS</p>
          <div>
            <Formik
        ...
        <div className={styles.checkoutRight}>
          ...
          <div className={styles.checkoutRightBox}>
            <div className={styles.checkoutRightSum}>
              <p className={styles.textInCart}>ITEM IN CART</p>
